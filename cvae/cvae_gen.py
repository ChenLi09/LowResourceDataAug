...
def cvae(output_file):
    ...
    word_vocab_file = os.path.join(data_dir, config['word_vocab_file'])
    ...
    ckpt_file = best_model + 'bert_model.ckpt'
    # ckpt_dir = best_model
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        vars_to_restore = [v for v in vars if v.name.split('/')[0] == 'bert']
